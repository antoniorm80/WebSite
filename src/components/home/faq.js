        ...
        <div id="faq" className="block faqBlock">
            <div className="container-fluid">
                <div className="titleHolder">
                    ...
                    <p> All the Lorem Ipsum generators on making this the first true generator on the Internet.</p>
                </div>
                ...
                <div className="quickSupport">
                    ...
                    <Button type="primary" size="large" icon={<MailOutlined/>}> Email your question</Button>
                </div>
            </div>
        </div>
    )
